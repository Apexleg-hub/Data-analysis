...
DROP DATABASE   /*!32312 IF EXISTS*/ GB_Point;

CREATE DATABASE GB_Point; 

use gb_point;

CREATE TABLE Customers (CustomerID	INT PRIMARY KEY,CustomerName	VARCHAR(100),ContactName	VARCHAR(100),Address	VARCHAR(100),City	VARCHAR(100),
PostalCode	VARCHAR(100), Country VARCHAR(100));
...
Insert into Employee (EmployeeID,	LastName,	FirstName,	BirthDate,	Notes)
VALUES (1, 	'Davolio', 	'Nancy', 	'12/8/1968', 	 	'Education includes a BA in psychology from Colorado State University.'),
	(2, 	'Fuller', 	'Andrew',	'2/19/1952', 		'Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas. He is fluent in French and Italian and reads German. He joined the company as a sales representative, was promoted to sales manager and was then named vice president of sales. Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association'),
	(3, 	'Leverling', 	'Janet', 	'8/30/1963' ,		'Janet has a BS degree in chemistry from Boston College). She has also completed a certificate program in food retailing management. Janet was hired as a sales associate and was promoted to sales representative.'),

	(4, 	'Peacock', 	'Margaret', 	'9/19/1958', 'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London, where he was promoted to sales manager. Mr. Buchanan has completed the courses Successful Telemarketing and International Sales Management. He is fluent in French. '),
	(6, 	'Suyama', 	'Michael', 	'7/2/1963', 	'Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing). He has also taken the courses Multi-Cultural Selling and Time Management for the Sales Professional. '), 
	(7, 	'King', 	'Robert', 	'5/29/1960', 	'Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan and then joining the company. After completing a course entitled Selling in Europe.'), 
	(8, 	'Callahan', 	'Laura', 	'1/9/1958', 		'Laura received a BA in psychology from the University of Washington. She has also comple'), 
	(9, 	'Dodswort', 	'Anne', 	'7/2/1969', 		'Anne has a BA degree in English from St. Lawrence College. She is fluent in French and German.'),
	(10, 	'West', 	'Adam', 	'9/19/1928',	'An old chum');
...
(35, 			'HILARIÓN-Abastos', 				'Carlos Hernández', 		'Carrera 22 con Ave.', 		'San Cristóbal',	'5022', 		'Venezuela'), 
...
(11, 	'Heli Subwaren GmbH & Co.KG', 				'Petra Winkler', 				'Tiergartenstraße 5', 				'Berlin',			'10785',		'Germany',		'(010) 9984510' ),
(12, 	'Plutzer Lebensmittelgrobmärkte AG', 		'Martin Bein', 					'Bogenallee 51', 					'Frankfurt', 		'60439', 		'Germany', 		'(069) 992755' ),
...
insert into Petty_Cash( Number, DESCRIPTION, 				WEEK_1,		WEEK_2,			WEEK_3,		WEEK_4,	AMOUNT)
Values
					(1,		'TRANSPORTATION EXPENSES',		10500.00, 		 15200.00, 		25030.00, 	 12700.00, 	 63430.00),
					(2,		'OFFICE MAINTENANCE',			5600.00, 		4700.00, 		9500.00, 	 3000.00, 	 22800.00 ),
					(3,		'CLEANING SERVICES',			9500.00, 		10500.00, 		5500.00, 	 7000.00, 	 32500.00 ),
					(4,		'REPAIR OF GENERATOR',			13500.00, 		NULL,			NULL,		8000.00, 	 21500.00 ),
					(5,		'REGISTRATION FEES',			25000.00, 		NULL,			NULL,		NULL,		25000.00 ),
					(6,		'ENTERTAINMENT', 				17500.00, 		15000.00,		NULL,		NULL,	 	 32500.00), 
					(7,		'FUEL/ PETROL', 				8000.00, 		9500.00, 		7000.00, 	 5000.00, 	 29500.00 ),
					(8,		'ASSOCIATION FEES',				15000.00, 		NULL,			NULL,			NULL,	 15000.00 ),
					(9,		'WATER',						6000.00, 		 8500.00,		NULL,			NULL,	 14500.00), 
					(10,	'INTERNENT SUBSCRIPTION',		 15000.00, 	NULL,			NULL,			NULL,	15000.00 ),
					(11,	'INK',							7500.00, 		 10000.00, 	NULL,		    NULL,		17500.00 ),
					(12,	'A4 PAPER',						15000.00, 		10000.00, 		NULL,		   NULL,		25000.00), 
					(13,	'LOADING EXPENSES',				18500.00, 		12000.00, 		22300.00, 	 9000.00, 	 61800.00), 
					(14,	'REPAIR OF TRUCK',				27500.00, 		NULL,				NULL,		NULL,	27500.00 ),
					(15,	'PURCHASE OF NEWS PAPER',		2000.00, 		3200.00, 		1600.00, 	 2400.00, 	 9200.00), 
					(16,	'LABOUR EXPENSES',				23000.00, 		24800.00, 		25000.00, 	 15000.00, 	 87800.00 ),
					(17,	'RECHARGE CARD',				5200.00,		 6200.00, 		3800.00, 	 NULL,		15200.00 ),
					(18,	'PAYMENT FOR ELECTRICITY BILL',	 5600.00, 		 8700.00, 	     NULL,       NULL,      14300.00), 
					(19,	'COMMUNITY EXPENSES',			25000.00, 		NULL,            NULL,		NULL,		25000.00 ),
					(20,	'SECURITY EXPENSES',		    20000.00, 	      NULL,          NULL,        NULL,     20000.00), 
					(21,	'PUBLIC RELATIONS',		        17500.00,	 		NULL,        NULL,        NULL,     17500.00 );
